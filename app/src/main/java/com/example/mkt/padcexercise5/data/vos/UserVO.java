...
import com.example.mkt.padcexercise5.data.persistence.AttractionsContract;
...
public class UserVO {
    ...
    public Date getRegisteredDate() {
        try {
            ...
            Log.d(MyanmarAttractionApp.TAG, e.getMessage());
        }
    ...
    public void saveLoginUser() {
        ...
        Log.d(MyanmarAttractionApp.TAG, "Login User Inserted Uri : " + insertedUri);
    }
