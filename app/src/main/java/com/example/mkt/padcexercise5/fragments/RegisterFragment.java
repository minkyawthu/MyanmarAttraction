...
import com.example.mkt.padcexercise5.adapters.CountryListAdapter;
...
public class RegisterFragment extends Fragment{
    ...
    @Bind(R.id.lbl_registration_title)
    ...
    public void onTapRegister(Button register) {
